...
namespace RecipeApi.Migrations
{
    ...
    [Migration("20250506041455_AddAccountCRUDPermission")]
    partial class AddAccountCRUDPermission
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RecipeApi.Entities.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("8e83d27f-f32a-4ce3-a649-5dbdd0f65492"),
            ...
            modelBuilder.Entity("RecipeApi.Entities.PermissionMethod", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("2c964ec8-73a7-4df1-a5f2-8719b98d1f66"),
                            Created = new DateTime(2025, 5, 5, 18, 13, 46, 418, DateTimeKind.Utc).AddTicks(6150),
                            Method = "view",
                            PermissionId = new Guid("8e83d27f-f32a-4ce3-a649-5dbdd0f65492")
                        },
                        new
                        {
                            Id = new Guid("f152c922-aeba-4b0d-8905-a4d9c4933f2f"),
                            Created = new DateTime(2025, 5, 5, 18, 13, 46, 418, DateTimeKind.Utc).AddTicks(6150),
                            Method = "create",
                            PermissionId = new Guid("8e83d27f-f32a-4ce3-a649-5dbdd0f65492")
                        },
                        new
                        {
                            Id = new Guid("71a8a751-be7f-43e9-898d-7c90c005162b"),
                            Created = new DateTime(2025, 5, 5, 18, 13, 46, 418, DateTimeKind.Utc).AddTicks(6150),
                            Method = "update",
                            PermissionId = new Guid("8e83d27f-f32a-4ce3-a649-5dbdd0f65492")
                        },
                        new
                        {
                            Id = new Guid("5c82a2ad-1379-40ae-ba63-1662c0f225aa"),
                            Created = new DateTime(2025, 5, 5, 18, 13, 46, 418, DateTimeKind.Utc).AddTicks(6150),
                            Method = "delete",
                            PermissionId = new Guid("8e83d27f-f32a-4ce3-a649-5dbdd0f65492")
                        });
            ...
            modelBuilder.Entity("RecipeApi.Entities.RolePermissionMethod", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("dab5ac1e-d4f8-4e84-a574-7f46617dc2c6"),
                            Created = new DateTime(2025, 5, 5, 18, 13, 46, 418, DateTimeKind.Utc).AddTicks(6150),
                            PermissionMethodId = new Guid("2c964ec8-73a7-4df1-a5f2-8719b98d1f66"),
                            RoleId = new Guid("e287d2e0-9ca7-4a6e-aafe-08982ff2c5f8")
                        },
                        new
                        {
                            Id = new Guid("be014f21-20cb-4e58-a8ed-b26e558065a1"),
                            Created = new DateTime(2025, 5, 5, 18, 13, 46, 418, DateTimeKind.Utc).AddTicks(6150),
                            PermissionMethodId = new Guid("f152c922-aeba-4b0d-8905-a4d9c4933f2f"),
                            RoleId = new Guid("e287d2e0-9ca7-4a6e-aafe-08982ff2c5f8")
                        },
                        new
                        {
                            Id = new Guid("64e49d9d-c288-4fb3-aa7d-7aad3f9869e7"),
                            Created = new DateTime(2025, 5, 5, 18, 13, 46, 418, DateTimeKind.Utc).AddTicks(6150),
                            PermissionMethodId = new Guid("71a8a751-be7f-43e9-898d-7c90c005162b"),
                            RoleId = new Guid("e287d2e0-9ca7-4a6e-aafe-08982ff2c5f8")
                        },
                        new
                        {
                            Id = new Guid("453f0a3a-cc2a-4d6c-9919-621bfdd3e16f"),
                            Created = new DateTime(2025, 5, 5, 18, 13, 46, 418, DateTimeKind.Utc).AddTicks(6150),
                            PermissionMethodId = new Guid("5c82a2ad-1379-40ae-ba63-1662c0f225aa"),
                            RoleId = new Guid("e287d2e0-9ca7-4a6e-aafe-08982ff2c5f8")
                        });
                });
